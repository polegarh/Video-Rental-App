...
public class Data {
  ...
  static public Video newVideo(String title, int year, String director) {
	if (title == "" || title == " " || title == null || year <= 1800 || year >= 5000 || director == "" || director == " " || director == null){ 
  ...
  static public UndoableCommand newOutCmd(Inventory inventory, Video video) {
	if (!(inventory instanceof InventorySet) || !(video instanceof VideoObj)) throw new IllegalArgumentException();
